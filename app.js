...
const THEME_BG = { light: '#F4ECE2', dark: '#140D0A' };
...
const MOON_ICON = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>';
...
function applyTheme(theme) {
  ...
  // Icon shows the theme a tap will switch *to*
